...
internal object ProblemsTable : Table("problems") {
    ...
    val referenceSolutionCode = text("reference_solution_code")
    val referenceSolutionHash = varchar("reference_solution_hash", length = 66)
    val referenceRuntimeMs = integer("reference_runtime_ms").nullable()
    val referenceMemoryUsedKb = integer("reference_memory_used_kb").nullable()
    val referenceConsensusNodes = integer("reference_consensus_nodes").nullable()
